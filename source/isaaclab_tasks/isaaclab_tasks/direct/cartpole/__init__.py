...
gym.register(
    id="Isaac-Cartpole-AMP-Direct-v0",
    entry_point=f"{__name__}.cartpole_amp_env:CartpoleAmpEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.cartpole_amp_env:CartpoleEnvCfg",
        "skrl_amp_cfg_entry_point": f"{agents.__name__}:skrl_amp_cfg.yaml",
    },
)

gym.register(
    id="Isaac-Cartpole-GAIL-Direct-v0",
    entry_point=f"{__name__}.cartpole_gail_env:CartpoleGailEnv",
    disable_env_checker=True,
    kwargs={
